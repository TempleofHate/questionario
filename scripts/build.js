import { validateCraniometria } from './validate-craniometria.js';
...
const craniometria = await validateCraniometria();
...
await writeFile(new URL('../dist/validation.json', import.meta.url), JSON.stringify({ ...report, visual, muscularVisual, skullTheory, craniometria }, null, 2));
console.log('Build concluído em dist/. Bancos validados: 150 questões originais + 40 questões por músculo + 70 questões visuais de ossos + 70 questões visuais musculares + 40 questões tradicionais de crânio + 40 questões de Craniometria.');
